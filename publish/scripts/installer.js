    ...
    return new Promise(function(resolve, reject) {
        ...
        */
        ...
        if (forcePrepare) {
            ...
            const googleServicesValuesXmlPath = path.join(platformsDir, platform, "app", "build", "generated", "res", "google-services", "debug", "values")
            const mergeDebugResourcesPath = path.join(platformsDir, platform, "app", "build", "intermediates", "incremental", "mergeDebugResources")
